const spellsLVL5 = [
  {
    ...
    shortdesc:
      "Creates a 10 ft wide barrier around you that blocks out any living creatures for up to an hour.",
    desc: [
  ...
  },
  {
    ...
    url: "/api/spells/geas",
    shortdesc:
      "f the target can understand you, it makes a Wis save. On a failure, it becomes charmed and must obey a command you give. ",
    desc: [
  ...
  },
  {
    ...
    shortdesc:
      "Creates a 20ft sphere of biting locusts that deal 4d10 piercing damage on a failed Con save on anyone inside or entering.",
    desc: [
