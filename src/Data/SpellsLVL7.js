const spellsLVL7 = [
  {
    ...
    shortdesc:
      'Creates a storm of raining fire that deals damage on a failed Dex save.',
    desc: [
  ...
  },
  {
    ...
    shortdesc:
      'You make terrain look, sound, smell, and even feel like some other sort of terrain',
    desc: [
  ...
  },
  {
    ...
    shortdesc:
      'You and up to eight are transported to a different plane of existence.',
    desc: [
  ...
  },
  {
    ...
    shortdesc:
      'Target heals at the start of each turn for 1 hour. Severed body members restored after two minutes.',
    desc: [
